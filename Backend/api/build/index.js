...
app.post("/api/report_user", function (req, res) {
  ...
  var mailOptions = {
    ...
    text: ""
      .concat(req.body.user, " has reported ")
      .concat(req.body.reportUser, "'s message.\nMessage: \"")
  ...
  else res.status(500).send("SERVER ERROR: ".concat(error));
});
// Block user endpoint
...
app.listen(port, function () {
  console.log(
    "Server Ready and listening on port ".concat(
      port,
